...
namespace rebel::search
{
    class InformationSet
    {
        ...
        private:
            template<typename T>
            static T make_zeroed_map(std::span<const propnet::PropId> legal_inputs);
    ...
    template<typename T>
    T InformationSet::make_zeroed_map(std::span<const propnet::PropId> legal_inputs)
    {
        T map {};
    ...
    class ExternalSamplingMCCFR
    {
        ...
        private:
            ...
            ExpectedValue make_traversers_move(
