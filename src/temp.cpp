...
static constexpr auto NUM_GAMES{20};
...
int main(void)
{
    ...
    for (player::Depth depth_limit{1}; depth_limit < 5; ++depth_limit)
    {
        ...
        {
            std::cout << "Total reward for '" << role << "' at depth " << depth_limit << ": " << total_reward << '\n';
        }
    }
