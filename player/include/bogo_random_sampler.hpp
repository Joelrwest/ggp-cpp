...
class BogoRandomSampler
{
  public:
    ...
    BogoRandomSampler(const BogoRandomSampler &other) = default;
    BogoRandomSampler(BogoRandomSampler &&other) = default;

    BogoRandomSampler &operator=(const BogoRandomSampler &other) = default;
    BogoRandomSampler &operator=(BogoRandomSampler &&other) = default;
