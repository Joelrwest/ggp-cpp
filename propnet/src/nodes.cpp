...
AndNode::AndNode(PropId id, std::span<const PropId> ins) : Node{id}, ins{ins.begin(), ins.end()}
{
}
...
OrNode::OrNode(PropId id, std::span<const PropId> ins) : Node{id}, ins{ins.begin(), ins.end()}
{
}
...
PropositionNode::PropositionNode(PropId id, std::string_view display) : Node{id}, display{display}
{
}
...
BasicPropositionNode::BasicPropositionNode(PropId id, std::string_view display, PropId in)
    : PropositionNode{id, display}, in{in}
{
}
...
InputPropositionNode::InputPropositionNode(PropId id, std::string_view display) : PropositionNode{id, display}
{
}
...
InitialPropositionNode::InitialPropositionNode(PropId id, std::string_view display) : PropositionNode{id, display}
{
}
...
PreTransitionNode::PreTransitionNode(PropId id, PropId in) : Node{id}, in{in}
{
}
...
PostTransitionNode::PostTransitionNode(PropId id, PropId pre_id) : Node{id}, pre_id{pre_id}
{
}
...
NotNode::NotNode(PropId id, PropId in) : Node{id}, in{in}
{
}
...
TrueNode::TrueNode(PropId id) : Node{id}
{
}
